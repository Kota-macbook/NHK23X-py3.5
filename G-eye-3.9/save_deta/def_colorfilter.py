...
#ポールは(H, S, V)=(22.98, 188.84, 212) ただし、範囲は(0~180,0~255,0~255)
    ...
    low_H = int(senter[0]-haba[0])
    low_S = int(senter[1]-haba[1])
    low_V = int(senter[2]-haba[2])
    ...
    upper_H = int(senter[0]+haba[0])
    upper_S = int(senter[1]+haba[1])
    upper_V = int(senter[2]+haba[2])
    if upper_H>179:
       upper_H -= 180
